...
export default function WeeklyPage() {
  return <main>
    <header className="page-hero"><p className="eyebrow">WEEKLY POLICY UPDATE · 2026-07-27—2026-08-02</p><h1>本周最新政策</h1><p>截至 2026-08-03，仅记录本周完成官方核验的新增、修订、截止与移出事项。</p></header>
    <SiteNav />
