...
export default function Home() {
  return <main>
    <section className="hero"><p className="eyebrow">BEIJING · AI POLICY INTELLIGENCE</p><div className="hero-grid"><div><h1>北京 AI<br />政策情报</h1><p className="intro">覆盖国家、北京市和重点区的 AI、大模型、算力与数据政策；每周核验、分类沉淀、动态维护。</p></div><aside className="as-of"><span>本期截止</span><strong>2026-08-03</strong><p>中国标准时间 · 第 31 周</p></aside></div></section>
    <SiteNav />
    ...
    <section className="role-entry"><div className="section-heading"><p className="eyebrow">ROLE-BASED BRIEFING</p><h2>按角色使用</h2><p>同一套政策库，分别服务管理判断与客户沟通。</p></div><div className="role-entry-grid"><a className="role-entry-card leadership-entry" href="/leadership"><span>管理视角</span><h3>领导看政策</h3><p>3 条核心判断、重点机会、风险和管理建议。</p><strong>进入领导摘要 ↗</strong></a><a className="role-entry-card client-entry" href="/client-manager"><span>一线视角</span><h3>客户经理找机会</h3><p>按 7 类客户准备政策话题、需求问题和下一步动作。</p><strong>进入会前准备卡 ↗</strong></a></div></section>
    <section className="subsidy-entry"><div><p className="eyebrow">SUBSIDY &amp; SOURCE INTELLIGENCE</p><h2>补贴申报雷达</h2><p>当前有 {subsidyMetrics.current} 项已核验可申报窗口，另有 {subsidyMetrics.waiting} 项政策有效但等待批次。依据链、趋势预警、客户准备度和扫描过的网址集中在两个入口。</p></div><div className="subsidy-entry-links"><a href="/subsidies"><span>当前可申报 · 依据链 · 趋势与预警</span><strong>进入补贴申报雷达 ↗</strong></a><a href="/sources"><span>扫描网址集合 · 核验状态 · 关联政策</span><strong>打开政策来源库 ↗</strong></a></div></section>
