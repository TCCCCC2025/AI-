...
export default function Home() {
  return <main>
    <section className="hero"><p className="eyebrow">BEIJING · AI POLICY INTELLIGENCE</p><div className="hero-grid"><div><h1>北京 AI<br />政策情报</h1><p className="intro">覆盖国家、北京市和重点区的 AI、大模型、算力与数据政策；每周核验、分类沉淀、动态维护。</p></div><aside className="as-of"><span>本期截止</span><strong>2026-07-30</strong><p>中国标准时间 · 第 30 周</p></aside></div></section>
    <SiteNav />
