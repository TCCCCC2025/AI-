...
export default function Home() {
  return <main>
    <section className="hero"><p className="eyebrow">BEIJING · AI POLICY INTELLIGENCE</p><div className="hero-grid"><div><h1>北京 AI<br />政策情报</h1><p className="intro">覆盖国家、北京各层级及重点外省市的 AI、大模型、算力与数据政策；每周核验、分类沉淀、动态维护。</p></div><aside className="as-of"><span>本期截止</span><strong>2026-08-24</strong><p>中国标准时间 · 第 34 周</p></aside></div></section>
    <SiteNav />
