...
export default function Home() {
  return <main>
    ...
    <section className="subsidy-entry"><div><p className="eyebrow">SUBSIDY APPLICATION RADAR</p><h2>把政策机会变成可申报清单</h2><p>单独汇总北京市级、各区和经开区的 Token/模型券、算力券、数据券、备案、场景和 OPC 支持，先看窗口，再看金额、条件和入口。</p></div><a href="/subsidies"><span>当前窗口 · 全部有效库 · 区域覆盖</span><strong>进入补贴申报雷达 ↗</strong></a></section>
